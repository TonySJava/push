...
public class MessgeTemplate {
	 ...
	 * @return
	 */
	public static LinkTemplate getlinkTemplateAndroid(String appId, String appKey, String title, String text,
			String url) {
...
//		return template;
	 ...
	 * @return
	 */
	public static NotificationTemplate getNotificationTemplateAndroid(String appId, String appKey, String title,
			String text, Map<String, Object> customContent) {
	 ...
	 * @return
	 */
	public static NotificationTemplate getNotificationTemplateAndroidSimple(String appId, String appKey, String title,
																	  String text) {
		NotificationTemplate template = new NotificationTemplate();
		// 设置APPID与APPKEY
		template.setAppId(appId);
...
//		}
	 ...
	 * @return
	 */
	public static TransmissionTemplate getTransmissionTemplateIOS(String appId, String appKey, String title,
			String text, Map<String, Object> customContent) {
	 ...
	 * @return
	 */
	public static TransmissionTemplate getTransmissionTemplateIOSSimple(String appId, String appKey, String title,
																  String text) {
		TransmissionTemplate template = new TransmissionTemplate();
		template.setAppId(appId);
		template.setAppkey(appKey);
...
//		}
	 ...
	 * @return
	 */
	public static TransmissionTemplate transmissionTemplateToSingle(String appId,String appKey,String text,String title) {
		//content 内容为推送显示内容
		TransmissionTemplate template = new TransmissionTemplate();
