...
public class AppPushMessage {
	 ...
	 * @return
	 */
	public static AppMessage getAppMessageAllIOS(String appId, String appKey, String title, String Text, Map map) {

		// 定义"点击链接打开通知模板"，并设置标题、内容、链接
		TransmissionTemplate template = MessgeTemplate.getTransmissionTemplateIOS(appId, appKey, title, Text, map);
	 ...
	 * @return
	 */
	public static AppMessage getUrlIOS(String appId, String appKey, String title, String Text, String url) {
	 ...
	 * @return
	 */
	public static SingleMessage getAppMessageSingleAndroidSimple(String appId, String appKey, String title, String text) {

		NotificationTemplate template = MessgeTemplate.getNotificationTemplateAndroidSimple(appId, appKey, title, text);
		SingleMessage message = new SingleMessage();
		message.setOffline(true);
		// 离线有效时间，单位为毫秒，可选
		message.setOfflineExpireTime(24 * 3600 * 1000);
	 ...
	 * @return
	 */
	public static SingleMessage getAppMessageSingleIOSSimple(String appId, String appKey, String title, String text) {
		// 通知透传模板
